...
```{r, out.width = '500pt', fig.retina = 2, echo = FALSE, fig.cap = 'Figure 1. Plot of Thresholding Function with $\\lambda = 2$', fig.align = 'center'}
knitr::include_graphics("assets/images/AdaptiveLassoFigure1.png")
```
